        ...
        <div className="w-[32%] h-auto">
          ...
          >
            ...
            <div className="border layer" data-depth="0.2">
              <img className="opacity-0" src={imgLayer} alt="550x640" />
              <div className="inner absolute top-[25px] bottom-[-25px] left-[25px] right-[-25px] border-[10px] border-solid border-[#041230]"></div>
            </div>
          </div>
        </div>
        <div className="w-[68%] pl-20">
          <h3 className="text-headingColor text-[24px] mb-4">
            I'm Nguyen Duc and &nbsp;
            <TypeAnimation
          ...
          <div className="mt-6 mb-10">
            <ul className="grid grid-cols-2 gap-5">
              <li className="flex items-center">
                <span className="flex gap-4 items-center text-smallTextColor">
                  <label className="font-[700] text-[14px] text-headingColor min-w-[85px] inline-flex items-center">
                    Birthday:
                  </label>
                  15.01.2003
                </span>
              ...
              <li className="flex items-center">
                <span className="flex gap-4 items-center">
                  <label className="font-[700] text-[14px] min-w-[85px] inline-flex items-center">
                    Mail:
                  </label>
                  <a
              ...
              <li className="flex items-center">
                <span className="flex gap-4 items-center">
                  ...
                  <a className="text-smallTextColor" href="#">
                    0888804085
                  </a>
                </span>
              </li>
          ...
          <div className="pt-4 pb-4 pl-6 pr-6 bg-primaryColor text-white font-[500]  gap-2 inline-flex items-center ">
            <ul>
              <li>
                <a href="#" download>
